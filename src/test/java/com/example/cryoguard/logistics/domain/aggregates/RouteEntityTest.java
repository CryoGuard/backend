...
class RouteEntityTest {
    ...
    void shouldHaveAuthorizedOperatorIdField() {
        Route route = new Route("R001", "Test Route", RouteStatus.INITIATED,
    ...
    void shouldAddContainerAssignmentToRoute() {
        Route route = new Route("R003", "Test Route 3", RouteStatus.INITIATED,
    ...
    void shouldUseNewConstructorWithoutContainerId() {
        Route route = new Route("R005", "Viaje Quito", RouteStatus.INITIATED,
        ...
        assertEquals(RouteStatus.INITIATED, route.getStatus());
    }
    ...
    void shouldHaveProgressField() {
        ...
        Route route = new Route("R006", "Test Route", RouteStatus.INITIATED,
                "Origin", "Destination", BigDecimal.valueOf(100),
    ...
    void shouldUpdateAuthorizedOperatorId() {
        Route route = new Route("R008", "Test Route", RouteStatus.INITIATED,
                "Origin", "Destination", BigDecimal.valueOf(100),
                60, 10, LocalDateTime.now(), LocalDateTime.now().plusHours(1), null);
