...
public class AlertasController {
    ...
    @GetMapping
    @Operation(summary = "Get all alertas", description = "Retrieves all alerts with optional filtering by status, severity, or container ID.")
    public ResponseEntity<Page<AlertIncidentResource>> getAllAlertas(
